...
class ResConfig(models.TransientModel):
    ...
    key_ai_api = fields.Char(string="Clé API IA (Gemini)", config_parameter='odoo_whatsapp_ai.key_ai_api')
    ai_model = fields.Selection([
        ('gemini-1.5-flash', 'Gemini 1.5 Flash (Rapide)'),
        ('gemini-1.5-pro', 'Gemini 1.5 Pro (Précis)'),
        ('gpt-4o', 'OpenAI GPT-4o'),
    ], string="Modèle IA Actif", config_parameter='odoo_whatsapp_ai.ai_model', default='gemini-1.5-flash')